...
const CLIENT_FIELDS = [
  ...
  { value: "lineItemsList", label: "Lista pozycji (nazwa, ilość, kwota brutto)" },
  ...
  { value: "invoiceAdvancePct", label: "Zaliczka 1 — procent" },
  { value: "invoiceAdvanceAmount", label: "Zaliczka 1 — kwota (brutto)" },
  { value: "invoiceAdvanceNetAmount", label: "Zaliczka 1 — kwota (netto)" },
  { value: "invoiceAdvance2Pct", label: "Zaliczka 2 — procent" },
  { value: "invoiceAdvance2Amount", label: "Zaliczka 2 — kwota (brutto)" },
  { value: "invoiceAdvance2NetAmount", label: "Zaliczka 2 — kwota (netto)" },
...
const SAMPLE_DATA: Record<string, string> = {
  ...
  name: "ZL/2026/001",
  lineItemsList: "Okno PVC biały 100×100 cm\nDrzwi antracyt 90×210 cm",
  estimateTotal: "12 000,00 zł",
  estimateNetTotal: "9 756,10 zł",
  invoiceVatPct: "100%",
  invoiceVatAmount: "12 000,00 zł",
  invoiceVatNetAmount: "9 756,10 zł",
  invoiceAdvancePct: "40%",
  invoiceAdvanceAmount: "4 800,00 zł",
  invoiceAdvanceNetAmount: "3 902,44 zł",
  invoiceAdvance2Pct: "40%",
  invoiceAdvance2Amount: "4 800,00 zł",
  invoiceAdvance2NetAmount: "3 902,44 zł",
  invoiceFinalPct: "20%",
  invoiceFinalAmount: "2 400,00 zł",
  invoiceFinalNetAmount: "1 951,22 zł",
